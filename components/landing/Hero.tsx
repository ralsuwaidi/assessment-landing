...
export default function Hero(heroProp: HeroType) {
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            {heroProp.secondaryButton &&
                                <a href={heroProp.secondaryButton.url} className="text-sm font-semibold leading-6 text-gray-900">
                                    {heroProp.secondaryButton.text} <span aria-hidden="true">→</span>
                                </a>
                            }
